; FreeSO Norwegian Language Pack
; Copyright (C) 2014  Afr0
;
...
OutFile FreeSO Norwegian Language Pack.exe
...
Name "FreeSO Norwegian Language Pack"
...
LangString LSTR_2 1033 "FreeSO Norwegian Language Pack"
...
LangString LSTR_54 1033 "FreeSO Norwegian Language Pack"
...
Page directory /ENABLECANCEL
  DirText $(LSTR_40) $(LSTR_41) $(LSTR_42) $(LSTR_43)    ;  "Setup will install $(LSTR_54) in the following folder. To install in a different folder, click Browse and select another folder. $_CLICK" "Destination Folder" B&rowse... "Select the folder to install $(LSTR_54) in:" "FreeSO Norwegian Language Pack" "FreeSO Norwegian Language Pack"
  DirVar $CMDLINE
...
Function .onInit
  ReadRegStr $_0_ HKLM "SOFTWARE\Maxis\The Sims Online\" InstallDir
  StrCmp $_0_ "" label_4
  StrCpy $INSTDIR $_0_
  Goto label_28
label_4:
  StrCmp $_0_ "" 0 label_28
  IfFileExists "$PROGRAMFILES\Maxis\The Sims Online" 0 label_8
  StrCpy $INSTDIR "$PROGRAMFILES\Maxis\The Sims Online\"
  Goto label_28
label_8:
  IfFileExists "$PROGRAMFILES\Maxis\The Sims Online\" 0 label_11
  StrCpy $INSTDIR "$PROGRAMFILES\Maxis\The Sims Online\"
  Goto label_28
label_11:
  IfFileExists "$PROGRAMFILES64\Maxis\The Sims Online\" 0 label_14
...
label_14:
  ...
  Dialogs::Folder "Folder selection" "Locate The Sims Online installation folder:" $EXEDIR 21
    ...
    ; Push 21
    ; Push $EXEDIR
    ; Push "Locate The Sims Online installation folder:"
    ; Push "Folder selection"
    ; CallInstDLL $PLUGINSDIR\Dialogs.dll Folder
  StrCmp $INSTDIR "" label_24 label_26
label_24:
...
label_26:
  ...
  Goto label_29
label_28:
  CreateDirectory $TEMP\FSOInstaller
label_29:
FunctionEnd


Section Main ; Section_0
  ; AddSize 413
